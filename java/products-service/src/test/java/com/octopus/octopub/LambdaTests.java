...
public class LambdaTests extends BaseTest {
  ...
  public void testLambdaCreateAndGet() throws DocumentSerializationException {
    ...
    final ProxyResponse postResponse =
        productApi.handleRequest(apiGatewayProxyRequestEvent, Mockito.mock(Context.class));
  ...
  public void testLambdaCreateAndUpdate() throws DocumentSerializationException {
    ...
    final APIGatewayProxyRequestEvent patchApiGatewayProxyRequestEvent =
        new APIGatewayProxyRequestEvent();
    patchApiGatewayProxyRequestEvent.setHeaders(
        new HashMap<>() {
          {
            put("Accept", "application/vnd.api+json,application/vnd.api+json; dataPartition=main");
          }
    ...
    patchApiGatewayProxyRequestEvent.setBody(
        productToResourceDocument(
            resourceConverter, createProduct("testCreateAndGetProductUpdated")));
    final ProxyResponse patchResponse =
        productApi.handleRequest(patchApiGatewayProxyRequestEvent, Mockito.mock(Context.class));
  ...
  public void testLambdaCreateAndDelete() throws DocumentSerializationException {
    ...
    final APIGatewayProxyRequestEvent deleteApiGatewayProxyRequestEvent =
        new APIGatewayProxyRequestEvent();
    deleteApiGatewayProxyRequestEvent.setHeaders(
        new HashMap<>() {
          {
            put("Accept", "application/vnd.api+json,application/vnd.api+json; dataPartition=main");
          }
    ...
    final ProxyResponse deleteResponse =
        productApi.handleRequest(deleteApiGatewayProxyRequestEvent, Mockito.mock(Context.class));
