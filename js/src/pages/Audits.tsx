...
const Audits: FC<CommonProps> = (props: CommonProps): ReactElement => {
    ...
    return (
        <>
            ...
            {audits && <DataGrid
                rows={audits.data.map((a: Audit) => ({id: a.id, subject: a.attributes.subject, action: a.attributes.action, object: a.attributes.object, dataPartition: a.attributes.dataPartition}))}
                columns={columns}
                pageSize={5}
